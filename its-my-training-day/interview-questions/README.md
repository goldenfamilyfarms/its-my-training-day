...
### Advanced Data Processing Questions

11. **Event Aggregation and Time-Based Rollup** (`11-nodejs-event-aggregation-rollup.ts`)
...
12. **Sampling with Risk Bias** (`12-nodejs-sampling-risk-bias.ts`)
...
- **Event Aggregation:** Combining events, reducing storage
- **Time-Based Rollup:** Multiple granularities, efficient queries
- **Control-Level Rollup:** Compliance metrics, trend analysis
- **Risk-Based Sampling:** Intelligent event selection
- **Adaptive Sampling:** Volume-based adjustments
...
- [Time-Series Data Best Practices](https://www.influxdata.com/time-series-database/)
